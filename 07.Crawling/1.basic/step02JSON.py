...
실습단계
    ...
    3. json 객체로 변환: json 파일로부터 read해서 json객체 활용

고려사항
    1. 한글 데이터 보호(인코딩)
    2. 생성된 json파일 내의 데이터 검증 필수
        validation 검증 사이트 활용: https://jsonformatter.org/
'''
import json
